...
class Main extends React.Component {
  ...
  render() {
    ...
    // <---- (Read) search or find by name and by lastName datalist items --->
    ...
    const onSearchByLastName = (e) => {
      let result1 = users.filter((value) =>
        value.lastName.toLowerCase().includes(e.target.value)
      );
      this.setState({ dataList: result1 });
    };
